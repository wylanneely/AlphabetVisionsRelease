...
class WordGoalController {
    ...
    //MARK: - Lesson Groups
    let ant = WordGoal(letter: "A", word: "Ant")
    let ape = WordGoal(letter: "A", word: "Ape")
    let axe = WordGoal(letter: "A", word: "Axe")
    let ark = WordGoal(letter: "A", word: "Ark")
    let amp = WordGoal(letter: "A", word: "Amp")
    let apple = WordGoal(letter: "A", word: "Apple")
    ...
    var setTestA: [WordGoal] {  return [coffee,bagel,banana,cookie,bread] }
    var setTestB: [WordGoal] {  return [lamp,vase,cupcake,bread,ape] }
    var setTest3: [WordGoal] {  return [can,cup,candle,chair,cookie] }
    
    
    var setA1: [WordGoal] {  return [ant,ape,axe,ark,amp] }
